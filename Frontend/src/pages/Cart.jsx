...
const Cart = () => {
  ...
  return (
   <div className='container flex justify-around items-start flex-wrap mx-auto mt-8 '>
            {cartItems.length === 0 ? (<div>Your cart is empty <Link to='/shop' className='hover:text-blue-700 hover:underline'>Go to Shop</Link></div>):
...

                {
                  cartItems.map((item)=>(
                    <div key={item._id} className='flex items-center mb-[1rem] pb-2 ' >
                          ...
                          <div className='w-24'>
                            <select className='w-full p-1 border rounded text-block bg-black' value={item.qty}
                            ...
                            <div>
                              ...
                              onClick={()=> removeFormCartHandler(item._id)}>
                                  <FaTrash className='ml-[2rem] mt-[.5rem]'/>
                              </button>
                            </div>
                    </div>
                  ))
                          ...
                          <div className='mt-8 w-[50rem]'>
                           ...
                           <button className="bg-pink-800 mt-4 py-2 px-4 rounded-full text-lg w-full hover:bg-pink-700" 
